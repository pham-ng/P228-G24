...
console.log('Generated golden_dataset_vi.csv with', goldenRows.length - 1, 'rows');

// 2. Diagnostic Dataset (from cases.json + rag-eval-report.json + offline-answers)
...
console.log('Generated diagnostic_dataset_vi.csv with', diagRows.length - 1, 'rows');

// 3. Real User Dataset (100 cases)
...
console.log('Generated real_user_dataset_vi.csv with', realUserRows.length - 1, 'rows');

// 4. Regression Dataset (50 cases)
...
console.log('Generated regression_dataset_vi.csv with', regRows.length - 1, 'rows');
...
console.log('Generated evaluation_results.csv with', evalRows.length - 1, 'rows');
...
console.log('Generated failure_cases.csv with', failRows.length - 1, 'rows');
